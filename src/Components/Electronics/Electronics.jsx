...
import Img1 from '../../assets/electronics/e1.jpg'
import Img2 from '../../assets/electronics/e2.jpg'
import Img3 from '../../assets/electronics/e3.jpg'
import Img4 from '../../assets/electronics/e4.jpg'
import Img5 from '../../assets/electronics/e5.jpg'
...
const Electronics = () => {
  return (
    <div id='Electronics' className='mt-14 mb-12'>
    <div className='container'>
      {/* Header Section  */}
      <div className='text-center mb-10 max-w-[600px] mx-auto'>
          <p data-aos="fade-up" className='text-sm text-primary'>Top selling Electronics Prducts for you</p>
