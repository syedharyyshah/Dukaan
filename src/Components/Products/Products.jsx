...
import Img2 from '../../assets/women/women22.jpg'
...
const Products = () => {
  return (
    <div id='womens' className='mt-14 mb-12'>
      <div className='container'>
        {/* Header Section  */}
        <div className='text-center mb-10 max-w-[600px] mx-auto'>
            <p data-aos="fade-up" className='text-sm text-primary'>Top selling Women Prducts for you</p>
            <h1 data-aos="fade-up" className='text-3xl font-bold'>Women</h1>
