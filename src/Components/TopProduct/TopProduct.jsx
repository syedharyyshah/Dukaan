...
const ProductsData = [
    {
        ...
        title:"Casual Wear",
        description:
        "Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea accusamus repudiandae, omnis quam nam exercitationem doloremque consequatur, in fugit ab dolores quibusdam pariatur, aliquam quia alias soluta debitis sunt delectus."
    },
    {
        id:2,
        img:Img2,
...
const TopProduct = ({handleOrderPopup}) => {
  return (
    <div>
      <div id='Top Product' className='container'>
        {/* Header section  */}
        <div className='text-left mb-24 '>
            <p data-aos="fade-up" className='text-sm text-primary'>Top Rated Prducts for you</p>
        ...
        md:grid-cols-3 gap-20 md:gap-5 place-items-center'>
            {ProductsData.map((data) => (
                ...
                relative shadow-xl duration-high group max-w-[300px]'>
                  ...
                  <button
                  className='bg-primary hover:scale-150
